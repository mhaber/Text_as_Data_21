...
6.  Configure Git and set your _user name_ and _email_ (the email address you used to register on GitHub). You can directly open the Git prompt from within RStudio. User name and email needs to be set only once. Go to _Tools > Shell_ to open the Git Shell to tell Git your username and GitHub email.
...
knitr::include_graphics("img/gitshell.png")
```
